### Naive Bayes
library(e1071)
train <- read.csv("C:/Users/abab1/Documents/GitHub/R-code-repository/work7/data/hw7_train.csv", stringsAsFactors = F)
...
test <- read.csv("C:/Users/abab1/Documents/GitHub/R-code-repository/work7/data/hw7_test.csv")
test.predict <- predict(model, newdata = test)
submit <- data.frame(id=test$id, label=test.predict)
write.csv(submit, file = "C:/Users/abab1/Documents/GitHub/R-code-repository/work7/result/naivebayes.csv",
          row.names = F, quote = F)

### Logit
library(class)
train <- read.csv("C:/Users/abab1/Documents/GitHub/R-code-repository/work7/data/hw7_train.csv")
train$label <- as.factor(train$label)
y <- "label"
...
submit <- data.frame(id=test$id, label=test.predict)
write.csv(submit, file = "C:/Users/abab1/Documents/GitHub/R-code-repository/work7/result/logit.csv",
          row.names = F, quote = F)
...
submit <- data.frame(id=test$id, label=test.predict)
write.csv(submit, file = "C:/Users/abab1/Documents/GitHub/R-code-repository/work7/result/randomforest.csv",
          row.names = F, quote = F)
...
model <- svm(formula = label ~ feature1 + feature2 + feature3 + feature4 + feature5 +
               feature6 + feature7 + feature8 + feature9 + feature10 +
               feature11 + feature12 + feature13 + feature14 + feature15 +
               feature16 + feature17 + feature18 + feature19 + feature20, data = train, kernel = "radial", cost = 10)
resultframe <- data.frame(truth=train$label, pred=predict(model, newdata = train))
tab <- table(resultframe)
train.accuracy <- round(sum(diag(tab))/sum(tab),2)
...
test.predict <- predict(model, newdata = test)
submit <- data.frame(id=test$id, label=test.predict)
write.csv(submit, file = "C:/Users/abab1/Documents/GitHub/R-code-repository/work7/result/radialsvm.csv",
          row.names = F, quote = F)
...
write.csv(submit, file = "C:/Users/abab1/Documents/GitHub/R-code-repository/work7/result/xgboost.csv",
          row.names = F, quote = F)
