...
```R
Rscript hw3_studentID.R --fold 5 --input Archaeal_tfpssm.csv --output hw3/your_ID/output1.csv
...
Rscript hw3_studentID.R --fold 10 --input Archaeal_tfpssm.csv --output hw3/your_ID/output6.csv
```
